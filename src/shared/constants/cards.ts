...
export const CHARACTERS: Record<Module, Record<string, Character>> = {
  [Module.Core]: {
    ...
    char_4: {
      ...
      credits: 0,
      objective: "Have at least 1 modification and 2 gears with combined cost of at least [[Credits]] 15000",
      baseAbility: {
        description: "<strong>Action:</strong> Heal 2 damage of your Character and 2 damage of your Ship.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
      ...
      advancedAbility: {
        description: "<strong>Encounter:</strong> Start a combat against a Player on your space with Fame equal or higher than you. If you win, gain 1 Fame.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
    ...
    char_5: {
      ...
      baseAbility: {
        description: "<strong>Action:</strong> Secretly look 1 Contact on your planet.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
      ...
      advancedAbility: {
        description: "After eliminating a Bounty Contact instead of capturing them, gain [[Credits]] 5000",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
    ...
    char_6: {
      ...
      baseAbility: {
        description: "Once per turn, during a combat or skill test, you can change one of your [[Focus]] to one [[Critical]]",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
      ...
      advancedAbility: {
        description: "When a Patrol up to 3 spaces from you is going to move during your <b>Action</b> phase, you can move it on the direction of other Player instead.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
    ...
    char_7: {
      ...
      baseAbility: {
        description: "<strong>Encounter:</strong> Start an Encounter with a Patrol or Contact up to 3 spaces from you.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
    ...
    char_8: {
      ...
      baseAbility: {
        description: "After rolling dice (For any reason), you can reroll 1 of your dice.",
        modifier: {
          character: {
            attack: 0,
            armor: 0,
